...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/02/08 11:29:55 by ffloris           #+#    #+#             */
/*   Updated: 2019/02/08 11:29:56 by ffloris          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static bool	map_file_to_memory(t_nm_otool *nm_otool, int fd)
{
	...
	if (nm_otool->file.memory == MAP_FAILED)
		return (false);
	nm_otool->file.end_of_file = nm_otool->file.memory
		+ nm_otool->file.size - 1;
	return (true);
}
